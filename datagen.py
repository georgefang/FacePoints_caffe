...
class DataGenerator():
	...
	def _sam_generator(self, batch_list, batch_size = 16, normalize = True, sample_set = 'train'):
		""" Sample Generator
		Args:
		...
		train_gtmap = np.zeros((batch_size, out_size, out_size, int(self.joints_num)), np.float32)
